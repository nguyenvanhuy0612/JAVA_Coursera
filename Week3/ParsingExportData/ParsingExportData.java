...
public class ParsingExportData {
    ...
    public void tester() {
        ...
        //System.out.println("numberOfExporters: " + numberOfExporters(parser, "gold"));
        //System.out.println("numberOfExporters: " + numberOfExporters(parser, "cocoa"));
    ...
    public void bigExporters1(CSVParser parser, String amount){
        for (CSVRecord record : parser){
            String currentDollar = record.get("Value (dollars)");
            currentDollar = currentDollar.replaceAll("\\s+","");
            if (currentDollar.length() > amount.length()){
