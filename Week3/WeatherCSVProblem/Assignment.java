...
public class Assignment {
    ...
    public String fileWithLowestHumidity(){
        ...
        System.out.println("Lowest Humidity on that day was "+lowestHumRow.get("Humidity"));

        FileResource fr = new FileResource(fileLowestHum);
        System.out.println("All the Humidity on the lowest Humidity of day were: "); 
        for (CSVRecord row : fr.getCSVParser()){       
    ...
    public void testFileWithLowestHumidity(){
        String abc = fileWithLowestHumidity();
    }
